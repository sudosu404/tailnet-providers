...
require (
	...
	github.com/yusing/go-proxy/agent v0.0.0-20250911143829-1be2ea44a234
	github.com/yusing/go-proxy/internal/dnsproviders v0.0.0-20250912034159-04d823d61670
